  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="relative p-2.5 hover:bg-white hover:bg-opacity-10 rounded-xl transition-all group"
      >
        <svg className="w-6 h-6 text-purple-200 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
