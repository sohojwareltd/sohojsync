...
const DeveloperSidebar = () => {
  ...
  const navItems = [
    { path: '/developer/dashboard', icon: HomeIcon, label: 'Dashboard' },
    { path: '/developer/projects', icon: ProjectsIcon, label: 'Projects' },
    { path: '/developer/tasks', icon: TasksIcon, label: 'Tasks' },
    { path: '/developer/calendar', icon: () => (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"/>
      </svg>
    ), label: 'Calendar' },
    { path: '/developer/chat', icon: () => (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clipRule="evenodd"/>
      </svg>
    ), label: 'Chat' },
    { path: '/developer/settings', icon: SettingsIcon, label: 'Settings' },
  ];
        ...
        <div className="p-3 border-t" style={{borderColor: '#e5e7eb'}}>
          <div className="flex items-center gap-2 p-2 rounded-lg bg-gray-50">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-gray-800 truncate">{user?.name || 'Developer'}</p>
