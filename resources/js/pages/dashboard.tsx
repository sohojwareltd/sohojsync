        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="relative overflow-hidden rounded-lg border bg-white shadow-sm hover:shadow-md transition-shadow" style={{borderColor: '#e5e7eb', borderTopColor: '#59569D', borderTopWidth: '3px'}}>
                        <div className="p-4">
                    ...
                    <div className="rounded-lg border bg-white shadow-sm" style={{borderColor: '#e5e7eb'}}>
                        ...
                        <div className="p-4 space-y-3">
                            <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                                ...
                                <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{background: '#59569D'}}>
