      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between bg-white border border-gray-100 rounded-lg p-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gray-900">{filteredProjects.length}</p>
          </div>
        </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${getStatusBadgeClasses(project.status)}`}>
                      ...
                      <div className="mb-2">
                        ...
                        <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                          <div
                            ...
                            style={{ width: `${project.progress || 0}%`, background: ACTION_COLOR }}
                          >
                          </div>
                        </div>
                      </div>
